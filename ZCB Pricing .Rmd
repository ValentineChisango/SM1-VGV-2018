...
Crude_Monte_Carlo = function(alpha = 0.08, beta = 0.8, sigma = 0.005, T = 5, r = 0.08, n = 1000, s = 200){
  
  # alpha, beta, sigma <- Fixed Parameters
  # T <- maturity time
  # r <- Initial rate at time 0
  # n <- Number of Simulations
  # s <- NUmber of Subintervals over time 
  
  #Simulate interest rates
  dt <- T/s # Length of subintervals
...
Antithetic_variates = function(alpha = 0.08, beta = 0.8, sigma = 0.005, T = 5, r = 0.08, n = 1000, s = 200){
  ...
  Average = (int+int.)/2   # The average of the expressions is taken for new estimate
  mean = mean(Average)  # The average of the expression is taken for the estimate
...
>>>>>>> 41945baef2df97a30ca577a6e0c9ce48a7fde78a
...
<<<<<<< HEAD
bond_price_CIR <- function(alpha =0.08,beta=0.8,sigma=0.005,t=0,T=1,r0 = 0.08){
=======
...
<<<<<<< HEAD
CIR_MC= function(alpha =0.08,beta=0.8,sigma=0.005,T=1,r0 = 0.08,n=1000,s=100){
=======
CIR_MC= function(alpha  = 0.08, beta = 0.8, sigma = 0.005, T = 5, r = 0.08, n = 1000, s = 200){
>>>>>>> 41945baef2df97a30ca577a6e0c9ce48a7fde78a
...
<<<<<<< HEAD
Control_Variates_estimate= function(alpha =0.08,beta=0.8,sigma=0.005,t=0,T=1,r0 = 0.08,n=1000,s=100){
  Crude_Monte_Carlo(alpha,beta,sigma,T,r0,n,s)[1]- CIR_MC(alpha,beta,sigma,T,r0,n,s)[1]+bond_price_CIR(alpha,beta,sigma,t,T,r0)
=======
Control_Variates_estimate = function(alpha = 0.08, beta = 0.8, sigma = 0.005,t = 0,T = 5,r = 0.08,n = 1000,s = 200){
  Crude_Monte_Carlo(alpha,beta,sigma,T,r,n,s)- CIR_MC(alpha,beta,sigma,T,r,n,s)[1]+bond_price_CIR(alpha,beta,sigma,t,T,r)
>>>>>>> 41945baef2df97a30ca577a6e0c9ce48a7fde78a
}


V=seq(0.01,0.05,0.01)
J=NULL
K=NULL
for ( i in 1:length(V)){
  J[i]=Control_Variates_estimate(r0=V[i])
  K[i]=bond_price(r=V[i])
}
P=(J-K)^2
P
```
