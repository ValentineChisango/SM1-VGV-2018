...
par(mfrow = c(2,2))
first <- as.vector(senses[1,2:9])
plot(1:8,first)
test <- as.vector(senses[2, 2:9])
lines(1:8,test, col="red", type="l")
...
par(mfrow = c(1,1))
plot(closed, x = time_vec, type = "l", ylim = c(0.53,0.65), xlab = "Number of time steps", ylab = "Estimated Price")
lines(x = time_vec, y = CN_conv, type = "l", lty = 2)
lines(x = time_vec, y = Impl_conv, type = "l", lty = 3, col = "blue")
lines(x = time_vec, y = Expl_conv, type = "l", lty = 4, col = "red")
...
plot(closed_1, x = trials_vec, type = "l",ylim = c(0.61,0.63), xlab = "Number of Trials", ylab = "Estimated Price")
lines(x = trials_vec, y = CR_conv, type = "l", lty = 2)
lines(x = trials_vec, y = AV_conv, type = "l", lty = 3, col = "blue")
lines(x = trials_vec, y = MM_conv, type = "l", lty = 4, col = "red")
lines(x = trials_vec, y = CV_conv, type = "l", lty = 5, col = "grey")

legend(x = 1500, y = 0.618, legend = c("Closed Form", "Crude", "Antithetic Variates", "Moment Matching","Control Variates"), lty = 1:5, col = c("black","black","blue", "red","grey"), cex = 0.5)
