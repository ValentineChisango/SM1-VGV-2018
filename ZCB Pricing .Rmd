...
Antithetic_variates = function(alpha =0.08,beta=0.8,sigma=0.005,T=5,r = 0.08,n=100000,s=200){
  dt <- T/s # Length of sub-intervals
  sim_path= matrix(0,s+1,n) # Matrix that stores rate pathways
...
Moment_Matching=function(alpha =0.08,beta=0.8,sigma=0.005,T=5,r0 = 0.08,n=100000,s=100){
...
CIR_MC= function(alpha =0.08,beta=0.8,sigma=0.005,T=5,r = 0.08,n=100000,s=200){
...
>>>>>>> e9e582cf578235fb501d4f55054412de1f3b7f12
