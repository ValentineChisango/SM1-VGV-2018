...
Antithetic_variates = function(alpha =0.08,beta=0.8,sigma=0.005,T=1,r = 0.08,n=1000,s=100){
  dt <- T/s # Length of sub-intervals
  sim_path= matrix(0,s+1,n) # Matrix that stores rate pathways
...
Moment_Matching=function(alpha =0.08,beta=0.8,sigma=0.005,T=1,r0 = 0.08,n=100000,s=100){
