...
# Plot of convergence
plot(closed_1, x = trials_vec, type = "l",ylim = c(0.619,0.63), xlab = "Number of Trials", ylab = "Estimated Price", lty = 2, lwd = 2,font.main = 1, main = "Monte Carlo Bond Prices over Number of Trials")
