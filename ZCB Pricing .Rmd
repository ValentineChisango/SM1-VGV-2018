...
plot(x=1:8,y=senses[1,2:9], ylim =c(0,2.2), xlab = "Numerical Method", ylab = "Bond Price", main = "Sensitivity Test: Time to maturity", xaxt = "n", col ="black", pch = 19, font.main = 1)
axis(1, at=1:8, labels=xvec)
lines(1:8, senses[4,2:9], col="red",type = "p", pch = 19)
lines(1:8, senses[5,2:9],col ="blue",type = "p", pch = 19)
legend("topright", inset = c(-0,0), legend = c("T=1", "T=5", "T=10"), lty = c(1,1,1), col = c("red","black","blue", "red"), cex = 0.8, bty ="n", pch = 19)

plot(x=1:8,y=senses[1,2:9], ylim =c(0.55,0.7), xlab = "Numerical Method", ylab = "Bond Price", main = "Sensitivity Test: Sigma", xaxt = "n", col ="black", pch = 19, font.main = 1)
axis(1, at=1:8, labels=xvec)
