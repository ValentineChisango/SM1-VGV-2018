...
plot(x=1:8,y=senses[1,2:9], ylim =c(0.58,0.66), xlab = "Numerical Method", ylab = "Bond Price", main = "Sensitivity Test: Alpha & Beta",  xaxt = "n", col ="black", pch = 19, font.main = 1)
axis(1, at=1:8, labels=xvec)
...
lines(x = time_vec, y = CN_conv, type = "l", lty = 2, lwd =1.5, col = "green")
lines(x = time_vec, y = Impl_conv, type = "l", lty = 2, col = "blue",lwd =1.5)
lines(x = time_vec, y = Expl_conv, type = "l", lty = 2, col = "red",lwd =1.5)
legend(x = 60, y = 0.62, legend = c("Closed Form", "Crank-Nicolson", "Implicit", "Explicit"), lty = c(1,2,2,2), col = c("black","green","blue", "red"), cex = 0.8, bty ="n")
