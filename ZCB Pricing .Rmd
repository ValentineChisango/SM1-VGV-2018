...
explicit <- function(alpha,beta,sigma,r,I,T){
...
X = explicit(0.08,0.8,0.005,0.03,1:50,T=1)
Z <- bond_price(0.08,0.8,0.005,0,1,0.03)
...
implicit <- function(alpha,beta,sigma,r,I,J,T){
...
R <- implicit(0.08,0.8,0.005,0.05,1:100,seq(-0.3,0.5,0.01),T=5)
